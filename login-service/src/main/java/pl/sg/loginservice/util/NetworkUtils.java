package pl.sg.loginservice.util;
...
/**
 * taken from https://github.com/smreeti/spring-security-with-zuul/blob/master/login-service/src/main/java/com/cogent/loginservice/utils/NetworkUtils.java
 */
